...
export const kcMessages = {
    ...
    "fi": {
        ...
        "updatePasswordMessage":
            "Vahva salasana sisältää sekaisin numeroita, kirjaimia ja symboleja. Se on vaikea arvata, ei muistuta oikeita sanoja ja on käytössä vain tällä tilillä.",
        ...
        "mobile": "Mobiili",
        "totpStep1":
            'Asenna <a href="https://freeotp.github.io/" target="_blank">FreeOTP</a> tai Google Authenticator ohjelma laiteellesi. Kummatkin sovellukset ovat saatavilla <a href="https://play.google.com">Google Play</a> ja Apple App Store kaupoissa.',
        ...
        "authenticatorFinishSetUpMessage":
            "Joka kerta kun kirjaudut Keycloak-tilillesi, sinua pyydetään antamaan kaksivaiheisen tunnistautumisen koodi.",
        "authenticatorSubTitle": "Aseta kaksivaiheinen tunnistautuminen",
        "authenticatorSubMessage":
            "Parantaaksesi tilisi turvallisuutta, ota käyttöön vähintään yksi tarjolla olevista kaksivaiheisen tunnistautumisen tavoista.",
        ...
        "backupcodesIntroMessage":
            "Jos menetät pääsyn puhelimeesi, voit silti kirjautua tilillesi käyttämällä varmuuskoodeja. Pidä ne turvassa ja saatavilla.",
        "realmName": "Realm",
        "doDownload": "Lataa",
        "doPrint": "Tulosta",
    ...
    "lv": {
        ...
        "updatePasswordMessage":
            "Droša parole satur ciparus, burtus un simbolus. To ir grūti uzminēt, tā nesatur reālus vārdus un tiek izmantota tikai šim kontam.",
