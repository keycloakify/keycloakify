...
export const kcMessages = {
    ...
    "cs": {
        ...
        "console-verify-email":
            "Musíte ověřit svou emailovou adresu. Odeslali jsme e-mail na {0}, který obsahuje ověřovací kód. Zadejte prosím tento kód do pole níže.",
    ...
    "da": {
        ...
        "bypassKerberosDetail":
            "Enten er du ikke logget ind via Kerberos eller også er din browser ikke sat op til Kerberos login. Tryk fortsæt for at logge ind på anden vis",
        ...
        "implicitFlowDisabledMessage":
            "Klienten må ikke foretage browser login med den givne response_type. Implicit flowet er deaktiveret for klienten.",
        ...
        "console-verify-email":
            "Du skal verificere din email adresse. En email er blevet sendt til {0} som indeholder en verificerings kode. Indtast koden i input feltet herunder.",
    ...
    "fi": {
        ...
        "bypassKerberosDetail":
            "Joko et ole kirjautunut Kerberoksen kautta tai selaintasi ei ole asetettu käyttämään Kerberosta kirjautumiseen.  Klikkaa jatkaaksesi kirjautumista jollain toisella tavalla",
        ...
        "federatedIdentityUnavailableMessage":
            "Käyttäjä {0} joka on tunnistettu henkilöllisyyden tarjoajalla {1} ei ole olemassa. Ota yhteyttä järjestelmänvalvojaan.",
        ...
        "standardFlowDisabledMessage":
            'Asiakas ei saa aloittaa selainkirjautumista annetulla vastaustyypillä ("response_type"). "Standard flow" on poistettu käytöstä asiakkaalla.',
        "implicitFlowDisabledMessage":
            'Asiakas ei saa aloittaa selainkirjautumista annetulla vastaustyypillä ("response_type"). "Implicit flow" on poistettu käytöstä asiakkaalla.',
        ...
        "identityProviderNotUniqueMessage":
            "Realm tukee useita henkilöllisyyden tarjoajia. Ei voitu määrittää, mitä henkilöllisyyden tarjoajaa pitäisi käyttää tunnistautumiseen.",
        ...
        "console-verify-email":
            "Sinun täytyy vahvistaa sähköpostiosoitteesi.  Sähköposti, mikä sisältää vahvistuskoodin, on lähetetty osoitteeseen {0}.  Ole hyvä ja kirjoita tämä koodi alapuolella olevaan kenttään.",
        ...
        "saml.post-form.js-disabled":
            "JavaScript on pois käytöstä. Suosittelemme vahvasti sen käyttöönottoa. Klikkaa alla olevaa nappia jatkaaksesi. ",
        "saml.artifactResolutionServiceInvalidResponse": "Unable to resolve artifact.",
    ...
    "hu": {
        ...
        "bypassKerberosDetail":
            "Vagy nem Kerberosszal lépett be, vagy a böngészője nem kezeli a Kerberos alapú belépést. Kérem kattintson a Folytat gombra, egy másik belépési módhoz.",
        ...
        "implicitFlowDisabledMessage":
            "Ez a kliens nem kezdeményezhet böngésző alapú beléptetést a megadott válasz típussal. Az implicit belépési eljárás (flow) tiltott a kliensen.",
    ...
    "pt-BR": {
        ...
        "implicitFlowDisabledMessage":
            "O cliente não tem permissão para iniciar o login com o response_type informado. O fluxo implícito está desabilitado para o cliente.",
        ...
        "console-verify-email":
            "Você precisa verificar o seu endereço de e-mail. Enviamos um e-mail para {0} que contém um código de verificação. Digite o código enviado no campo abaixo.",
