...
export const kcMessages = {
    ...
    "cs": {
        ...
        "expiredCodeMessage":
            "Platnost přihlášení vypršela. Přihlašte se znovu.",
        ...
        "noRelayStateInResponseMessage":
            "Neexistuje relay state relé v odpovědi od poskytovatele totožnosti.",
        "insufficientPermissionMessage":
            "Nedostatečná oprávnění k propojení identit.",
        "couldNotProceedWithAuthenticationRequestMessage":
            "Nemohu pokračovat s žádostí o ověření poskytovateli totožnosti.",
        "couldNotObtainTokenMessage":
            "Nelze získat token od poskytovatele totožnosti.",
        "unexpectedErrorRetrievingTokenMessage":
        ...
        "identityProviderDifferentUserMessage":
            "Ověřeno jako {0}, ale mělo by být ověřeno jako {1}",
        "couldNotSendAuthenticationRequestMessage":
            "Nelze odeslat žádost o ověření poskytovateli totožnosti.",
        "unexpectedErrorHandlingRequestMessage":
            "Neočekávaná chyba při zpracování požadavku na ověření poskytovateli totožnosti.",
        ...
        "staleEmailVerificationLink":
            "Odkaz, na který jste klikli, je starý starý odkaz a již není platný. Možná jste již ověřili svůj e-mail?",
        "identityProviderAlreadyLinkedMessage":
            "Federovaná identita vrácená {0} je již propojena s jiným uživatelem.",
        "confirmAccountLinking":
            "Potvrďte propojení účtu {0} poskytovatele totožnosti {1} s vaším účtem.",
    ...
    "en": {
        ...
        "staleCodeMessage":
            "This page is no longer valid, please go back to your application and log in again",
        "realmSupportsNoCredentialsMessage":
        ...
        "auth-username-form-help-text":
            "Start log in by entering your username",
    ...
    "pt-BR": {
        ...
        "kerberosNotSetUp":
            "Kerberos não está configurado. Você não pode acessar.",
        ...
        "loginTimeout":
            "Você demorou muito para entrar. Por favor, refaça o processo de login a partir do início.",
        ...
        "recaptchaNotConfigured":
            "Recaptcha é requerido, mas não foi configurado",
        ...
        "loginTotpStep3":
            "Digite o código único fornecido pelo aplicativo e clique em Ok para concluir a configuração.",
        "loginTotpStep3DeviceName":
            "Forneça um nome de dispositivo para ajudá-lo a gerenciar seus dispositivos OTP.",
        ...
        "accountTemporarilyDisabledMessage":
            "Conta temporariamente indisponível, contate o administrador ou tente novamente mais tarde.",
        "expiredCodeMessage":
        ...
        "invalidPasswordBlacklistedMessage":
            "Senha inválida de acordo com as políticas estabelecidas para o domínio.",
        ...
        "federatedIdentityExistsMessage":
            "Usuário com {0} {1} já existe. Por favor, entre em gerenciamento de contas para vincular a conta.",
        ...
        "delegationCompleteMessage":
            "YVoc00EA  pode fechar esta janela do navegador e voltar ao seu aplicativo.",
        ...
        "invalidPasswordMinLengthMessage":
            "Senha inválida: comprimento mínimo {0}",
        "invalidPasswordMinDigitsMessage":
            "Senha inválida: deve conter pelo menos {0} número(s)",
        "invalidPasswordMinLowerCaseCharsMessage":
            "Senha inválida: deve conter pelo menos {0} caractere(s) minúsculo",
        "invalidPasswordMinUpperCaseCharsMessage":
            "Senha inválida: deve conter pelo menos {0} caractere(s) maiúsculo",
        "invalidPasswordMinSpecialCharsMessage":
            "Senha inválida: deve conter pelo menos {0} caractere(s) especial",
        "invalidPasswordNotUsernameMessage":
            "Senha inválida: não deve ser igual ao nome de usuário",
        "invalidPasswordRegexPatternMessage":
            "Senha inválida: não corresponde ao padrão da expressão regular.",
        "invalidPasswordHistoryMessage":
            "Senha inválida: não pode ser igual a qualquer uma das {0} últimas senhas.",
        "invalidPasswordGenericMessage":
            "Senha inválida: a nova senha não corresponde às políticas de senha.",
        ...
        "bearerOnlyMessage":
            "Aplicativos somente ao portador não tem permissão para iniciar o login pelo navegador",
        "standardFlowDisabledMessage":
        ...
        "resetCredentialNotAllowedMessage":
            "Não é permitido redefinir credencial.",
        ...
        "couldNotProceedWithAuthenticationRequestMessage":
            "Não foi possível proceder à solicitação de autenticação para provedor de identidade.",
        "couldNotObtainTokenMessage":
            "Não foi possível obter token do provedor de identidade.",
        "unexpectedErrorRetrievingTokenMessage":
            "Erro inesperado ao recuperar token do provedor de identidade.",
        "unexpectedErrorHandlingResponseMessage":
            "Erro inesperado ao manusear resposta do provedor de identidade.",
        "identityProviderAuthenticationFailedMessage":
            "Falha na autenticação. Não foi possível autenticar com o provedor de identidade.",
        "couldNotSendAuthenticationRequestMessage":
            "Não foi possível enviar solicitação de autenticação para o provedor de identidade.",
        "unexpectedErrorHandlingRequestMessage":
        ...
        "invalidCodeMessage":
            "Código inválido, por favor faça login novamente através de sua aplicação.",
        "identityProviderUnexpectedErrorMessage":
        ...
        "identityProviderLinkSuccess":
            "Sua conta foi vinculada com sucesso com {0} conta {1} .",
        "staleCodeMessage":
            "Esta página não é mais válida. Volte ao seu aplicativo e faça login novamente",
        "realmSupportsNoCredentialsMessage":
            "O domínio não suporta qualquer tipo de credencial.",
        "credentialSetupRequired":
            "Não é possível fazer o login, é necessária configuração de credencial.",
        "identityProviderNotUniqueMessage":
        ...
        "staleEmailVerificationLink":
            "O link em que você clicou é um link antigo e não é mais válido. Talvez você já tenha verificado seu e-mail.",
        "identityProviderAlreadyLinkedMessage":
        ...
        "differentUserAuthenticated":
            "Você já está autenticado como usuário diferente '{0}' nesta sessão. Por favor, saia primeiro.",
        "brokerLinkingSessionExpired":
            "Vinculação de conta do provedor de identidade solicitada, mas a sessão atual não é mais válida.",
        ...
        "otp-help-text":
            "Digite um código de verificação do aplicativo autenticador.",
        ...
        "webauthn-error-api-get":
            "Falha ao autenticar usando Chave de Segurança.",
        "webauthn-error-different-user":
            "O primeiro usuário autenticado não é aquele autenticado pela Chave de Segurança.",
        "webauthn-error-auth-verification":
            "O resultado da autenticação da Chave de Segurança é inválido.",
        "webauthn-error-register-verification":
            "O resultado do registro da Chave de Segurança é inválido.",
        "webauthn-error-user-not-found":
