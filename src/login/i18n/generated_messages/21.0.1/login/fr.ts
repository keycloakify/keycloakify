...
const messages = {
    ...
    "oauth2DeviceVerificationFailedMessage":
        "Vous pouvez fermer cette fenêtre de navigateur et retourner sur votre appareil, puis réessayer de vous connecter.",
    ...
    "oauth2DeviceAuthorizationGrantDisabledMessage":
        "Le client n'est pas autorisé à initier OAuth 2.0 Device Authorization Grant. Le flux est désactivé pour ce client.",
    ...
    "delegationFailedMessage":
        "Vous pouvez fermer cette fenêtre de navigateur et retourner sur votre application console, puis réessayer de vous connecter.",
