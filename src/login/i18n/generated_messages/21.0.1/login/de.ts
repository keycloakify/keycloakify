...
const messages = {
    ...
    "recovery-code-config-warning-message":
        "Drucken Sie sie aus, laden Sie sie herunter oder kopieren Sie sie in einen Passwort-Manager und speichern Sie sie. Wenn Sie diese Einrichtung abbrechen, werden die Wiederherstellungscodes von Ihrem Konto entfernt.",
    ...
    "recovery-codes-download-file-description":
        "Wiederherstellungscodes sind einmalig verwendbare Passwörter, mit denen Sie sich bei Ihrem Konto anmelden können, wenn Sie keinen Zugriff auf Ihren Authentifikator haben.",
