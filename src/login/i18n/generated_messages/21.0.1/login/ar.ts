...
const messages = {
    ...
    "bypassKerberosDetail":
        "إما أنك لم تقم بتسجيل الدخول بواسطة البروتوكول Kerberos أو أن متصفحك لم يتم إعداده لتسجيل الدخول بواسطة البروتوكول Kerberos. الرجاء النقر على زر استمرار لتسجيل الدخول من خلال وسائل أخرى",
    ...
    "standardFlowDisabledMessage":
        "لا يسمح للعميل ببدء تسجيل الدخول باستخدام المتصفح مع قيمة response_type المعطاة. تم تعطيل الإجراء القياسي standard flow لهذا العميل.",
    "implicitFlowDisabledMessage":
        "لا يسمح للعميل ببدء تسجيل الدخول باستخدام المتصفح مع قيمة response_type المعطاة. تم تعطيل الإجراء الضمني implicit flow لهذا العميل.",
    ...
    "console-verify-email":
        "تحتاج إلى التحقق من عنوان بريدك الإلكتروني. لقد أرسلنا بريدًا إلكترونيًا إلى {0} يحتوي على رمز تحقق. الرجاء إدخال هذا الرمز في الأسفل.",
    ...
    "recovery-code-config-warning-message":
        "تأكد من طباعتها أو تنزيلها أو نسخها إلى مدير كلمات المرور واحتفظ بها. سيؤدي إلغاء هذا الإعداد إلى إزالة رموز مصادقة الاسترداد هذه من حسابك.",
    ...
    "recovery-codes-download-file-description":
        "رموز مصادقة الاسترداد هي رموز مرور تستخدم مرة واحدة وتسمح لك بتسجيل الدخول إلى حسابك إذا لم يكن لديك وصول إلى المصدق الخاص بك.",
