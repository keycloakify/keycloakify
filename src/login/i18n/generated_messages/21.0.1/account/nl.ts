...
const messages = {
    ...
    "updatePasswordMessage":
        "Een sterk wachtwoord bevat een mix van nummers, letters, en symbolen. Het is moeilijk te gokken, lijkt niet op een echt woord, en wordt alleen gebruikt voor dit account.",
    ...
    "authenticatorFinishSetUpMessage":
        "Elke keer wanneer u zich aanmeldt bij uw Keycloak-account, wordt u gevraagd om een tweefactorauthenticatiecode op te geven.",
    "authenticatorSubTitle": "Stel tweefactorauthenticatie in",
    "authenticatorSubMessage":
        "Schakel ten minste één van de beschikbare methoden voor tweefactorauthenticatie in om de beveiliging van uw account te verbeteren.",
